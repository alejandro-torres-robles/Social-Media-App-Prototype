...
"""
Esta funcion sube un archivo a un servidor de archivos
"""
...
"""
Clase para hacer publicaciones
"""
...
class Post(models.Model):
    ...
    caption = models.TextField(max_length=1000000, verbose_name="Caption")
...
class Stream(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="stream_user")
    ...
    def add_post(sender, instance, *args, **kwargs):
        ...
        for follower in followers:
            stream = Stream(user=follower.follower, post=post,
